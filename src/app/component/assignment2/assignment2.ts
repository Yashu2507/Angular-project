...
export class Assignment2 {
 ...
 getRowColor(role:string) {
  switch (role) {
    case 'Manager': return 'lightyellow';
    case 'Developer': return 'lightblue';
    case 'Tester': return 'lightpink';
    default: return 'white';
  }
}
  getSalaryBadgeColor(salary: number): string {
    if (salary > 70000) return 'green';
    else if (salary >= 40000 && salary <= 70000) return 'orange';
    else return 'red';
  }
}
